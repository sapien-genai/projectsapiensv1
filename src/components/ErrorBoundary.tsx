    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen bg-paper flex items-center justify-center p-4">
          <div className="max-w-2xl w-full bg-white border-4 border-ink shadow-brutal-xl p-8">
            ...
            {process.env.NODE_ENV === 'development' && this.state.error && (
              <div className="mb-6 p-4 bg-gray-100 border-2 border-ink">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-white border-2 border-ink shadow-brutal-sm hover:shadow-none hover:translate-x-[2px] hover:translate-y-[2px] transition-all font-bold uppercase tracking-tight"
              >
