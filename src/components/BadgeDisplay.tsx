      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-12">
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-info border border-ink p-6 shadow-brutal">
            ...
            <div className="bg-gold border border-ink p-6 shadow-brutal">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-ink text-xs font-extrabold uppercase tracking-tight mb-1">Total Points</p>
                  <p className="text-ink text-4xl font-extrabold">{totalPoints}</p>
                  <p className="text-ink text-xs font-semibold uppercase tracking-wide mt-1">
                    points earned
                  </p>
                </div>
                <Trophy className="w-12 h-12 text-ink opacity-30" strokeWidth={2} />
              </div>
            </div>

            <div className="bg-accent border border-ink p-6 shadow-brutal">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-ink text-xs font-extrabold uppercase tracking-tight mb-1">Completion</p>
                  <p className="text-ink text-4xl font-extrabold">
                ...
                <Award className="w-12 h-12 text-ink opacity-30" strokeWidth={2} />
              </div>
            </div>
          </div>
            ...
            {categories.map(category => {
              ...
              return (
                <button
                  ...
                  className={`px-4 py-2 border border-ink font-extrabold text-sm uppercase tracking-tight transition-all ${
                    selectedCategory === category
                      ? 'bg-ink text-white shadow-brutal-accent'
                      : 'bg-white text-ink shadow-brutal-sm hover:shadow-none hover:translate-x-[2px] hover:translate-y-[2px]'
                  }`}
                >
        ...
        {selectedCategory !== 'all' && (
          <div className="mb-6 bg-white border border-ink p-6 shadow-brutal-sm">
        ...
        {!user && (
          <div className="mt-12 bg-white border border-ink p-8 shadow-brutal">
